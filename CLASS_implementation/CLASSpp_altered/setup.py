...
classy_ext = Extension('classy_altered.classy', ['classy.pyx'] + cpp_source_files,
...
setup(
    name='classy_altered',  # ADD THIS: so 'conda list' tracks this as a separate installation
    libraries=[myclib],
    ...
    packages=[
        'classy_altered.bbn',    # CHANGED: 'classy' to 'classy_altered'
        'classy_altered.hyrec',  # CHANGED: 'classy' to 'classy_altered'
    ],
    package_dir={
        'classy_altered': '',    # (You already had this right!)
    },
    package_data={
        'classy_altered.bbn': ['*.dat'],    # CHANGED: 'classy' to 'classy_altered'
        'classy_altered.hyrec': ['*.dat'],  # CHANGED: 'classy' to 'classy_altered'
    },
)
